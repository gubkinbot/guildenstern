...
def start_message(message):
  logic.handler_commands('start', message.from_user.id, message.id)

@bot.message_handler(commands=['stop'])
def start_message(message):
  logic.handler_commands('stop', message.from_user.id, message.id)

@bot.message_handler(commands=['search'])
def start_message(message):
  logic.handler_commands('search', message.from_user.id, message.id)

@bot.message_handler(commands=['info'])
def start_message(message):
  logic.handler_commands('info', message.from_user.id, message.id)

@bot.message_handler(commands=['test'])
def start_message(message):
  logic.handler_commands('test', message.from_user.id, message.id)

@bot.message_handler(commands=['top'])
def start_message(message):
  logic.handler_commands('top', message.from_user.id, message.id)
